...
namespace Laboratorio2
{
    public class Vendedor : Usuario
    {
        ...
        public Vendedor(string nombre, string apellidoPaterno, string apellidoMaterno, string dni, string username, string password, 
            bool prioridad, string sexo, double eficiencia,string seguro,string domicilio,string informacion) :base(nombre, apellidoPaterno, apellidoMaterno, dni, username, password, prioridad){
            this.sexo = sexo;
